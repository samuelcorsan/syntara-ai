# Lista de números en español desde el 1 hasta el 100
numeros = [
...
# Parejas de (número en forma de texto, valor numérico)       
parejas = list(enumerate(numeros, 1))

# Ordenar las parejas basado en el nombre del número (posición 1 de cada pareja)
parejas_ordenadas = sorted(parejas, key=lambda x: x[1])       

# Obtener el primer elemento, que es el menor en orden alfabético
primero_ordenado = parejas_ordenadas[0]

# Mostrar el resultado
numero_texto, valor_numerico = primero_ordenado
print(f"El primer número en orden alfabético es {numero_texto} ({valor_numerico}).")